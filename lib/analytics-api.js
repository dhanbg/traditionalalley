...
export const analyticsAPI = {
  ...
  // Users/Customers
  getUsers: () => fetchFromStrapi('user-data?populate=*'),
  getUserById: (id) => fetchFromStrapi(`user-data/${id}?populate=*`),
  
  // Carts (representing orders/sales)
  getCarts: () => fetchFromStrapi('carts?populate=*'),
  getCartsByUser: (userDocumentId) => fetchFromStrapi(`carts?filters[user_datum][documentId][$eq]=${userDocumentId}&populate=*`),
