...
export default function CategoryTopPicks({ parentClass = "flat-spacing-3 pt-5 pb-2" }) {
                  ...
                  <div className="flat-collection-circle wow fadeInUp" data-wow-delay="0.3s">
                    <div dir="ltr" className="swiper tf-sw-collection">
                      <Swiper
                        ...
                        pagination={{
                          clickable: true,
                          el: ".spd-category-toppicks",
                        }}
                        navigation={{
                          prevEl: ".snbp-category-toppicks",
                          nextEl: ".snbn-category-toppicks",
                        }}
                      >
                        {products.length > 0 ? (
                      ...
                      <div className="d-flex d-lg-none sw-pagination-collection sw-dots type-circle justify-content-center spd-category-toppicks" />
                    </div>
                    <div className="nav-prev-collection d-none d-lg-flex nav-sw style-line nav-sw-left snbp-category-toppicks">
                      <i className="icon icon-arrLeft" />
                    </div>
                    <div className="nav-next-collection d-none d-lg-flex nav-sw style-line nav-sw-right snbn-category-toppicks">
