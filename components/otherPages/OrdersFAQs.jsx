            ...
            <div className="right" style={{ margin: '0 auto', maxWidth: '800px', padding: '0 20px' }}>
              ...
              <div className="terms-of-use-item item-scroll-target" id="shipping-delivery" style={{ marginBottom: '30px' }}>
                ...
                <div className="terms-of-use-content">
                  ...
                  <p style={{ marginBottom: '10px', lineHeight: '1.6' }}>A: Yes, we ship to selected countries. International shipping takes 12-21 business days (12-15 days express, 16-21 days economy). Additional customs duties may apply depending on your country's regulations.</p>
                </div>
              </div>
