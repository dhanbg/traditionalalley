...
import { products, products7, productsKids } from "@/data/productsWomen"; // Import the kids' products data
import React, { useEffect, useState } from "react";
import Link from "next/link";

const tabItems = ["Women", "Men", "Kids"]; // Add "Kids" to the tab items
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      if (activeItem === "Men") {
        ...
        setSelectedItems(productsKids); // Set products for "Kids"
      } else {
