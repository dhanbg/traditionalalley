          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 sm:py-6">
            <div className="flex-1 min-w-0">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-green-900 to-green-700 bg-clip-text text-transparent flex items-center">
                    <span className="text-2xl mr-2">💰</span>
                    Sales Analytics
                  </h1>
                  <p className="mt-1 text-xs sm:text-sm text-gray-600">
                    Revenue trends, sales performance, and financial insights
                  </p>
                </div>
              </div>
            </div>
            <div className="mt-4 sm:mt-0 flex items-center justify-between sm:justify-end space-x-2 sm:space-x-4">
              ...
              <button
                ...
                disabled={refreshing}
                className="group bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-3 py-2 sm:px-4 rounded-lg text-xs sm:text-sm font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          >
            <ErrorBoundary>
              <div className="animate-fadeIn">
                <SalesAnalytics tabId="sales" dateFilter={dateRange} />
              </div>
            </ErrorBoundary>
          </ClientOnly>
        </div>
