          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 sm:py-6">
            ...
            <div className="mt-4 sm:mt-0 flex items-center justify-between sm:justify-end space-x-2 sm:space-x-4">
              ...
              <button
                ...
                disabled={refreshing}
                className="group bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white px-3 py-2 sm:px-4 rounded-lg text-xs sm:text-sm font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          >
            <ErrorBoundary>
              <div className="animate-fadeIn">
                <CustomerAnalytics tabId="customers" dateFilter={dateRange} />
              </div>
            </ErrorBoundary>
          </ClientOnly>
        </div>
