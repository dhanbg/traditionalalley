...
export async function GET(request: NextRequest) {
  try {
    ...
    const strapiUrl = `${STRAPI_URL}/api/user-orders?filters[authUserId][$eq]=${authUserId}&pagination[limit]=${limit}&sort=${sort}&populate=*`;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const strapiUrl = `${STRAPI_URL}/api/user-orders`;
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const strapiUrl = `${STRAPI_URL}/api/user-orders/${orderId}`;
